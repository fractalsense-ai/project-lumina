"""Shim: canonical source at domain-packs/system/domain-lib/hw_probes/hw_loop_latency.py"""
from lumina.systools._domain_pack_loader import load_domain_pack_module as _l
_mod = _l("domain-packs/system/domain-lib/hw_probes/hw_loop_latency.py")
